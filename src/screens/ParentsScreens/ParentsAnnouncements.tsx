...
const announcements: Announcement[] = [
  {
    ...
    description:
      'The meeting will be conducted online via Zoom. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.',
    time: '30 Nov 2023, 10:00 AM',
    isUrgent: true,
  },
  {
    id: 2,
    title: 'Parent-Teacher Meeting Scheduled',
    description: 'The meeting will be conducted online via Zoom.',
    time: '30 Nov 2023, 10:00 AM',
    isUrgent: true,
  },
  {
...
const ParentsAnnouncement: React.FC = () =>{
  ...
  const handleNotificationPress = (type: number, action?: object) => {
    ...
    switch (type) {
      case 1:
      case 2:
        // console.log("Navigating to SubjectTasksScreen with subject_name:", action?.subject_name);
...
export default ParentsAnnouncement;
