...
const ParentsResetPassword: React.FC<EmailProps> = props => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await api.public.post('reset-password', {
        email,
        password,
      ...
      if (response.data.status === 'success') {
        Alert.alert('Your password has been resetted successfully');
      ...
      <View style={styles.bottomHalf}>
        <View style={styles.inputContainer}>
          <TextInput
            ...
            value={password} // Bind email state
            onChangeText={setPassword} // Update email state
          ...
          <View style={styles.passwordContainer}>
            <TextInput
              ...
              placeholderTextColor="#B3B3B3"
              value={password_confirmation} // Bind password state
              onChangeText={setPassword_Confirmation} // Update password state
            />
          </View>
        </View>
        <TouchableOpacity
...
export default ParentsResetPassword;
