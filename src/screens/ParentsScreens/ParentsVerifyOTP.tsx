...
const ParentsVerifyOTP: React.FC<EmailProps> = props => {
  const navigation = useNavigation();
  const [token, setToken] = useState('');
  const email =
    props.route.params?.email || props.route.params?.registration_no;
  ...
  const handleVerifyOTP = async () => {
    ...
    //   console.log('Response:', response.data);
      ...
      if (response.data.status === 'success') {
        ...
        navigation.navigate('ParentsResetPassword', {email, type});
...
export default ParentsVerifyOTP;
