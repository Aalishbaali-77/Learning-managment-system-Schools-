...
const ParentsRequestStudentEmail = () => {
  ...
  const handleRequestEmail = async () => {
    ...
    try {
      ...
      const response = await api.public.post('request-email', {
        email,
        type,
        registration_no,
      });
      ...
      if (response.data.status === 'success') {
        ...
        navigation.navigate('ParentsVerifyOTP', {registration_no, type});
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.passwordContainer}>
            <TextInput
              ...
              placeholderTextColor="#B3B3B3"
              value={registration_no} // Bind password state
              onChangeText={setRegistration_No} // Update password state
            />
          </View>
        </View>
        <TouchableOpacity
...
export default ParentsRequestStudentEmail;
